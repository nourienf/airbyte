...
- [Configure a Data Activation sync](https://docs.airbyte.com/data-activation/configure/)
- [Map fields from warehouse to Salesforce](https://docs.airbyte.com/data-activation/mapping/)
